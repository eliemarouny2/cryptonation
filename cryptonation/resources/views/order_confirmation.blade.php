               ...
               <div class="row d-flex justify-content-center">
                  ...
                  <div class="card">
                     <div class="invoice p-5">
                        <h5 class="bluish2">Your order Confirmed!</h5> <span
                           class="font-weight-bold d-block mt-4">Hello,
                                 ...
                                 <tr>
                                    <td>
                                       <div class="py-2"> <span class="d-block text-muted">Order Date</span> <span
                                             class="white-color">{{$date}}</span> </div>
                                    </td>
                                    <td>
                           ...
                           <div class="col-md-5">
                              <table class="table table-borderless">
                                 <tbody class="totals">
                                    ...
                                    <tr>
                                       <td>
                                          <div class="text-left"> <span class="white-color">Tax Fee</span> </div>
                                       </td>
                                       <td>
                                          <div class="text-right"> <span class="white-color">$7.65</span> </div>
                                       </td>
                                    </tr>
                                    <tr>
                                       <td>
                                          <div class="text-left"> <span class="white-color">Discount</span> </div>
                                       </td>
                                       <td>
                                          <div class="text-right"> <span class="greenish">$168.50</span> </div>
                                       </td>
                                    </tr>
                                    <tr class="border-top border-bottom">
                                       <td>
                                          <div class="text-left"> <span
                                                class="font-weight-bold white-color">Total</span>
                                          </div>
                                       </td>
                                       <td>
                        ...
                        <p class="font-weight-bold mb-0">Thanks for shopping with us!</p> <span>Cryptonation Team</span>
                     </div>
                  </div>
               </div>
            </div>
