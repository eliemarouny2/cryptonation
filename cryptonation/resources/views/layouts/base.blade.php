            ...
            <div id="mySidenav" class="sidenav">
                <div class="wrapper">
                    ...
                    <div class="cartitem row mt-4">
                        <div class="col-5">
                            <img src="/images/products/{{$cartitem->options['image_url']}}" class="cartitemimage"
                                alt="">
                        </div>
                ...
                <div class="collapse navbar-collapse" id="navbarsExample03">
                    ...
                    <ul class="navbar-nav me-auto mb-sm-0 centered2">
                        <li class="nav-item dropdown">
                            <a class="nav-link mdm mdmone dropdown-toggle" href="#" id="dropdown04"
                                data-bs-toggle="dropdown" aria-expanded="false"><img src="/images/icons/searchbtn.png"
                                    alt="logo" /></a>
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-md-6 col-12 pad-topper">
                    <div>
                        ...
                        <input type="email" name="sub_email" id="sub_email" class="mt-2 newsletter"
                            placeholder="Email" />
...
?>
                        ...
                        <div class="socialmedia">
                            ...
                            @endif
                            @if($mail->status)
                            <a href="mailto:{{$mail->social_url}}"><img src="/images/icons/mail.png"
                                    alt="mail icon" /></a>
                            @endif
                        </div>
                    </div>
