                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="" name="name" readonly value="{{$phrase->phrase}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="{{$phrase->id}}" onblur="editphrase('{{$phrase->id}}')" name="name" value="{{$phrase->$lang}}">
                                </div>
                            </div>
                        </div>
                        @endforeach
